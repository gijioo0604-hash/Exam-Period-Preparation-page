/* ============================================================
   ...
   ------------------------------------------------------------
   들어 있는 샘플 30문제의 출처에 대해

   샘플 문제의 출처는 워크숍 실습용 학습자료 세 개를 가리킵니다.
     항해학_기초.md · 선박기관_기초.md · 해사법규_요약.md

   이 파일들은 제가 만든 것이 아니라 워크숍에서 받은 자료라서
   저장소에 함께 올리지 않았습니다. 그래서 출처에 적힌 파일을
   저장소에서 찾으면 나오지 않습니다.

   30문제의 해설은 모두 그 자료에 적힌 내용만으로 썼습니다.
   자료에 없는 설명은 넣지 않았습니다. 직접 만드는 문제도 같게 해 주세요.
...
var QUESTION_BANK = [
  ...
  },
  {
    ...
    prompt: "편차 (偏差)",
    answer: "진북과 자북의 차이.\n장소와 연도에 따라 달라진다.",
    explain: "편차는 진북과 자북의 차이다. 배가 어디에 있느냐, 언제 재느냐에 따라 값이 달라진다. 배 자체 때문에 생기는 자차와는 원인이 다르다."
  },
  {
    id: "nav-005",
    subject: "항해학", unit: "방위와 침로",
    ...
    explain: "자차는 선체의 철재와 전기 장비가 자침에 주는 영향이다. 선수 방향에 따라 값이 달라지므로, 장소와 연도에 따라 달라지는 편차와 구분해서 외운다."
  },
  {
    id: "nav-006",
    subject: "항해학", unit: "항법의 종류",
  ...
  },
  {
    ...
    answer: true,
    explain: "자료의 항해 계기 표는 음향측심기의 확인 포인트로 '흘수 보정 여부 확인'을 들고 있다. 측정값을 그대로 쓰기 전에 보정 설정을 확인해야 한다."
  },
  {
    id: "nav-009",
    subject: "항해학", unit: "항해 계기",
    ...
    answer: 1,
    explain: "레이더는 상대운동과 진운동 표시를 구분해야 물표의 실제 움직임을 오판하지 않는다. 대수속력·대지속력 구분은 선속계, 진북·자북 지시는 컴퍼스에서 확인할 사항이다."
  },
  {
    id: "nav-010",
  ...
  },
  {
    ...
    prompt: "디젤기관 4행정의 순서",
    answer: "흡입 → 압축 → 폭발 → 배기",
    explain: "흡입 → 압축 → 폭발 → 배기 순서로 한 사이클이 완성된다. 2행정 기관은 소기와 압축, 폭발과 배기를 겹쳐 크랭크축 1회전에 한 사이클을 끝내는 점이 다르다."
  },
  {
    id: "eng-003",
    subject: "선박기관", unit: "디젤기관의 행정",
  ...
  },
  {
    ...
    explain: "냉각수 계통은 청수가 기관을 직접 냉각하고, 해수가 그 청수를 다시 냉각하는 2단 구조다."
  },
  {
    id: "eng-005",
    subject: "선박기관", unit: "주요 보조 계통",
    ...
    explain: "시동공기 계통은 압축공기를 실린더에 공급해 기관을 기동한다. 연료유·윤활유·냉각수 계통과 함께 주요 보조 계통 네 가지를 이룬다."
  },
  {
    id: "eng-006",
    ...
    answer: 2,
    explain: "암모니아는 연소 시 이산화탄소가 나오지 않는 것이 장점이고, 독성과 연소 안정성이 과제로 남아 있다."
  },
  {
    id: "eng-007",
    subject: "선박기관", unit: "친환경 연료",
  ...
  },
  {
    ...
    explain: "윤활유 계통 하나가 마찰 저감·냉각·밀봉·세정 네 가지를 함께 맡는다. 저장·청정·가열·분사 순으로 연료를 공급하는 연료유 계통과 묶어서 외우면 헷갈리지 않는다."
  },
  {
    id: "eng-009",
...

  {
    ...
    answer: 1,
    explain: "마주치는 상태에서는 양 선박이 각각 우현으로 변침한다. 한쪽만 피항하는 횡단·추월 상태와 다른 점이다."
  },
  {
    id: "law-002",
    subject: "해사법규", unit: "항법",
  ...
  },
  {
    ...
    answer: 1,
    explain: "플라스틱은 배출이 전면 금지된다. 그 밖의 폐기물은 종류와 거리 기준에 따라 배출 조건이 달라진다."
  },
  {
    id: "law-009",
    ...
    explain: "만재흘수선은 화물을 실을 수 있는 한계를 표시하며, 계절과 해역에 따라 다르게 적용된다."
  },
  {
    id: "law-010",
